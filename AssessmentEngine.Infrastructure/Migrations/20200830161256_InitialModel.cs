    ...
    public partial class InitialModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("5d587953-2fb4-4198-9a5d-e64095439783"), "ee43e1ac-c5d9-4aca-af2a-614feb8f7113", "Administrator", "ADMINISTRATOR" });

            migrationBuilder.InsertData(
                table: "ApplicationRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("d8105d5f-3a2e-428b-8c57-36398b196379"), "42c4b54f-2a90-4c03-8947-e35b1c3a6ddf", "Participant", "PARTICIPANT" });

            migrationBuilder.InsertData(
                table: "AssessmentTypes",
                columns: new[] { "AssessmentTypeId", "CreatedBy", "CreatedDate", "Name", "AssessmentTypeUid", "UpdateDate", "UpdatedBy" },
                values: new object[] { 1, null, new DateTime(2020, 8, 30, 11, 12, 55, 918, DateTimeKind.Local).AddTicks(3500), "DualNBack", new Guid("65aaf775-8017-4692-b675-5202a43921ae"), new DateTime(2020, 8, 30, 11, 12, 55, 937, DateTimeKind.Local).AddTicks(5620), null });

            migrationBuilder.InsertData(
                table: "AssessmentTypes",
                columns: new[] { "AssessmentTypeId", "CreatedBy", "CreatedDate", "Name", "AssessmentTypeUid", "UpdateDate", "UpdatedBy" },
                values: new object[] { 2, null, new DateTime(2020, 8, 30, 11, 12, 55, 937, DateTimeKind.Local).AddTicks(7030), "EFT", new Guid("c1e74233-fe5e-4578-bc54-b5f4fc388767"), new DateTime(2020, 8, 30, 11, 12, 55, 937, DateTimeKind.Local).AddTicks(7050), null });
