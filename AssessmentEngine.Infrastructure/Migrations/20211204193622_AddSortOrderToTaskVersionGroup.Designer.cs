...
namespace AssessmentEngine.Infrastructure.Migrations
{
    ...
    [Migration("20211204193622_AddSortOrderToTaskVersionGroup")]
    partial class AddSortOrderToTaskVersionGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssessmentEngine.Domain.Entities.AssessmentTypeBlockType", b =>
                {
                    ...
                    b.HasKey("AssessmentTypeId", "BlockTypeId");

                    b.HasIndex("BlockTypeId");

                    b.ToTable("AssessmentTypeBlockTypes");
            ...
            modelBuilder.Entity("AssessmentEngine.Domain.Entities.TaskVersionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("TaskVersionGroupId")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.Property<string>("TaskVersionName")
                        .IsRequired()
                        .HasMaxLength(250)
                    ...
                    b.Property<Guid>("Uid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("TaskVersionGroupUid");
                    ...
                    b.ToTable("TaskVersionGroups");
                });

            modelBuilder.Entity("AssessmentEngine.Domain.Entities.TaskVersionGroupBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("TaskVersionGroupBlockId")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.Property<Guid>("Uid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("TaskVersionGroupBlockUid");
            ...
            modelBuilder.Entity("AssessmentEngine.Domain.Entities.ApplicationUserAudit", b =>
                {
                    ...
                    b.Navigation("ApplicationUserAuditType");
                });
            ...
            modelBuilder.Entity("AssessmentEngine.Domain.Entities.Assessment", b =>
                {
                    ...
                    b.Navigation("AssessmentVersion");
                });
            ...
            modelBuilder.Entity("AssessmentEngine.Domain.Entities.AssessmentTypeBlockType", b =>
                {
                    b.HasOne("AssessmentEngine.Domain.Entities.AssessmentType", "AssessmentType")
                        .WithMany("AssessmentTypeBlockTypes")
            ...
            modelBuilder.Entity("AssessmentEngine.Domain.Entities.ApplicationUser", b =>
                {
                    b.Navigation("ApplicationUserAudits");

                    b.Navigation("AssessmentParticipants");
            ...
            modelBuilder.Entity("AssessmentEngine.Domain.Entities.AssessmentType", b =>
                {
                    b.Navigation("AssessmentTypeBlockTypes");

                    b.Navigation("AssessmentVersions");

                    b.Navigation("TaskVersionGroups");
                });
